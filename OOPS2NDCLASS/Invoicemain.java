...
public static void main(String args[])
{
	...
	pdesc=sc.nextLine();
	System.out.println("Enter the quantityofpurchased=");
	quantity=sc.nextInt();
	System.out.println("Enter the priceperitem=");
	price=sc.nextDouble();
	Invoice in=new Invoice(pnum,pdesc,quantity,price);
	System.out.println("Amount="+in.getInvoice());
